 ...
 * @author pc
 */
@WebServlet(name = "DeleteOfficeHour", urlPatterns = {"/DeleteOfficeHour"})
public class DeleteOfficeHour extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int rows = dbConn.Stmt.executeUpdate("DELETE FROM officehours WHERE staffName='"+StaffName+"' AND "
                     + "SlotFrom="+SlotFrom+" AND SlotTo="+SlotTo+" AND date='"+Date+"';");
