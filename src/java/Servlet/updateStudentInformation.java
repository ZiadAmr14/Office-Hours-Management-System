 ...
 * @author Pc
 */
@WebServlet(name = "updateStudentInformation", urlPatterns = {"/updateStudentInformation"})
public class updateStudentInformation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int rows = dbConn.Stmt.executeUpdate("Update students set studentName='"+username+"', studentPassword ='"+pw1+"',Department='"+department+"'"
                            + "WHERE studentEmail = '" + email + "' ;");
           request.getSession().setAttribute("studentName", username);
