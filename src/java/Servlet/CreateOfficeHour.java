 ...
 * @author pc
 */
@WebServlet(name = "CreateOfficeHour", urlPatterns = {"/CreateOfficeHour"})
public class CreateOfficeHour extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                int rows = dbConn.Stmt.executeUpdate("INSERT INTO officehours (staffName,SlotFrom,SlotTo,Subject,Department,"
                        + "Location,date) VALUES ('"+StaffName+"',"+SlotFrom+","+SlotTo+
                        ",'"+StaffSubject+"','"+StaffDepartment+"','"+Location+"','"+Date+"');");
            }
