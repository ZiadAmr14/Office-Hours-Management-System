<%-- 
    Document   : ChangeStudentInformation
    Created on : Jan 15, 2021, 6:17:34 PM
    Author     : Pc
--%>
    ...
    <body>
        ...
        <script>
            ...
            function checkForm(form) {
                ...
                checkEmail(form.username.value, form.pw1.value, form.department.value);
                return false;

            }
            function checkEmail(username, pw1, department) {
                var c;
                var xmlhttp = new XMLHttpRequest();
                
                xmlhttp.open("GET", "updateStudentInformation?username=" + username + "&pw1=" + pw1 + "&department=" + department, true);
                xmlhttp.send();
